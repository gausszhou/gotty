...
// *os.File returned by pty.Open. Linux termios API (TCGETS/TCSETS, uint req).
...
// pty.StartWithSize's name resolution: master.Name() only reports
// /dev/ptmx, and reopening it every time allocates useless new PTY pairs.
