...
type Options struct {
	...
	// AnswerQueries answers terminal queries (DA/DSR/DECRQM/OSC colors)
	// from the screen mirror when no browser client is attached — the
	// browser's own xterm answers them otherwise. Full-screen programs
